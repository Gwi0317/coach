...
/* Alternatives proposées pour varier déjeuners et dîners */
const REPAS_VAR = {
  dej: [
    { n:"poulet riz haricots",    f:[["poulet",150],["riz",110],["huile",10],["beurre",5],["parmesan",15],["haricots",200],["painmie",40],["carre",25]] },
    { n:"steak pâtes champignons",f:[["steak",125],["pates",130],["beurre",10],["parmesan",15],["huile",10],["champi",150],["wasa",25],["carre",25]] },
    { n:"truite riz avocat",      f:[["truite",150],["riz",110],["huile",5],["avocat",75],["haricots",150],["carre",25],["painmie",40]] },
    { n:"wraps thon crudités",    f:[["wrap",116],["thonhuile",104],["carre",50],["champi",100],["huile",5],["riz",80],["haricots",150]] },
  ],
  diner: [
    { n:"truite pâtes champignons", f:[["truite",150],["pates",110],["huile",10],["champi",150],["parmesan",10]] },
    { n:"cabillaud riz haricots",   f:[["cabillaud",200],["riz",110],["huile",15],["haricots",150],["ail",20]] },
    { n:"wraps poulet",             f:[["wrap",116],["poulet",130],["huile",10],["champi",100],["ail",30]] },
    { n:"thon pâtes",               f:[["thonhuile",104],["pates",120],["huile",10],["champi",150],["parmesan",15]] },
    { n:"steak riz avocat",         f:[["steak",125],["riz",110],["huile",5],["avocat",75],["haricots",150]] },
  ],
};
...
const DEFAULT_PROGRAM = {
  Lun: { id:"pec", name:"Pec + triceps", kind:"gym", tag:"Obligatoire", ex:[
    { id:"dch",       n:"Développé couché haltères",   s:4, r:[6,8],   kg:35,  inc:2.5, rest:150, tier:1,
      note:"Tu perds 2 reps sur les dernières séries : prends vraiment tes 2 min 30",
      alt:[{ id:"dch_bar", n:"Développé couché barre", kg:80, inc:2.5 }] },
    { id:"dim",       n:"Développé incliné Smith machine", s:3, r:[8,10], kg:50, inc:2.5, rest:120, tier:1,
      note:"1,25 kg de chaque côté pour monter",
      alt:[{ id:"dim_h", n:"Développé incliné haltères", kg:24, inc:2 }] },
    { id:"dips",      n:"Dips lestés",                 s:3, r:[6,8],   kg:10,  inc:2.5, rest:120, tier:1,
      alt:[{ id:"dips_m", n:"Dips machine assistée", kg:20, inc:5 }] },
    { id:"poulieuni", n:"Poulie unilatérale pec",      s:3, r:[10,12], kg:12,  inc:2,   rest:75,  tier:3,
      alt:[{ id:"pecdeck", n:"Pec deck", kg:45, inc:5 }] },
    { id:"tricorde",  n:"Triceps corde poulie basse",  s:3, r:[10,12], kg:15,  inc:2.5, rest:75,  tier:2,
      alt:[{ id:"tribarre", n:"Triceps barre poulie", kg:25, inc:2.5 }] },
    { id:"triext",    n:"Extension au-dessus de la tête", s:3, r:[8,10], kg:10, inc:2, rest:75, tier:3,
      note:"Descendu de 12 à 10 kg : tu étais 3 reps sous la cible à chaque série",
      alt:[{ id:"triext_p", n:"Extension poulie au-dessus de la tête", kg:15, inc:2.5 }] },
  ]},
  Mar: { id:"dos", name:"Dos + biceps", kind:"gym", tag:"Obligatoire", ex:[
    { id:"tract",    n:"Tractions",                  s:4, r:[5,8],   kg:0,  inc:2.5, rest:150, bw:1, tier:1,
      note:"4 × 8 propres et tu passes au lest",
      alt:[{ id:"tract_sup", n:"Tractions supination", kg:0, inc:2.5 }] },
    { id:"tirhor",   n:"Tirage horizontal",          s:4, r:[8,10],  kg:55, inc:5,   rest:120, tier:1,
      alt:[{ id:"rowhalt", n:"Rowing haltère unilatéral", kg:26, inc:2 }] },
    { id:"tirvert",  n:"Tirage vertical unilatéral", s:3, r:[10,12], kg:40, inc:5,   rest:90,  tier:2,
      alt:[{ id:"tirvert_b", n:"Tirage vertical barre", kg:55, inc:5 }] },
    { id:"pullover", n:"Pull over poulie",           s:3, r:[8,10],  kg:35, inc:5,   rest:75,  tier:2 },
    { id:"curlbar",  n:"Curl barre",                 s:4, r:[8,12],  kg:22.5, inc:2.5, rest:90, tier:2,
      note:"Tu es descendu à 20 kg la dernière fois : pars à 22,5 et tiens les 4 séries",
      alt:[{ id:"curlez", n:"Curl barre EZ", kg:22.5, inc:2.5 }, { id:"curlhalt", n:"Curl haltères", kg:12, inc:2 }] },
    { id:"curlinc",  n:"Curl banc incliné",          s:3, r:[8,12],  kg:8,  inc:2,   rest:75,  tier:3 },
    { id:"curlmart", n:"Curl marteau",               s:3, r:[10,12], kg:8,  inc:2,   rest:75,  tier:3 },
  ]},
  Mer: { id:"jambes", name:"Jambes", kind:"gym", tag:"Ne la saute pas", ex:[
    { id:"squat",   n:"Pendule squat",                    s:4, r:[6,8],   kg:110, inc:5,  rest:180, tier:1,
      note:"Ton record : 120 kg × 8",
      alt:[{ id:"squat_bar", n:"Squat barre", kg:100, inc:5 }, { id:"presse", n:"Presse à cuisses", kg:180, inc:10 }] },
    { id:"sdtjt",   n:"Soulevé de terre jambes tendues",  s:3, r:[8,10],  kg:35,  inc:2.5, rest:120, tier:1,
      alt:[{ id:"sdtjt_b", n:"SDT jambes tendues barre", kg:60, inc:5 }] },
    { id:"legext",  n:"Leg extension",                    s:3, r:[10,12], kg:60,  inc:5,  rest:75,  tier:2 },
    { id:"legcurl", n:"Leg curl assis",                   s:3, r:[10,12], kg:35,  inc:5,  rest:75,  tier:2,
      alt:[{ id:"legcurl_a", n:"Leg curl allongé", kg:30, inc:5 }] },
    { id:"hip",     n:"Hip thrust",                       s:3, r:[10,12], kg:35,  inc:5,  rest:90,  tier:2,
      alt:[{ id:"hip_b", n:"Hip thrust barre", kg:60, inc:10 }] },
    { id:"mollets", n:"Mollets debout",                   s:4, r:[12,15], kg:140, inc:10, rest:60,  tier:3,
      note:"Pause 1 s en bas, 1 s en haut",
      alt:[{ id:"mollets_a", n:"Mollets assis", kg:60, inc:5 }] },
  ]},
  Jeu: { id:"epaules", name:"Épaules + abdos", kind:"gym", tag:"Obligatoire", ex:[
    { id:"dm",        n:"Développé militaire barre",   s:4, r:[6,8],   kg:45, inc:2.5, rest:150, tier:1,
      note:"Tu tiens 6 partout : reste à 45 jusqu'à 8 sur les 4 séries",
      alt:[{ id:"dm_h", n:"Développé épaules haltères", kg:20, inc:2 }] },
    { id:"elevlat",   n:"Élévation latérale poulie",   s:4, r:[10,12], kg:12, inc:2,   rest:60,  tier:1,
      alt:[{ id:"elevlat_h", n:"Élévation latérale haltères", kg:10, inc:2 }] },
    { id:"arriere",   n:"Arrière d'épaule machine",    s:4, r:[12,15], kg:15, inc:2.5, rest:60,  tier:2,
      note:"Une série de plus depuis que l'élévation frontale saute",
      alt:[{ id:"arriere_h", n:"Oiseau haltères", kg:8, inc:2 }] },
    { id:"shrugs",    n:"Shrugs",                      s:3, r:[12,15], kg:30, inc:5,   rest:75,  tier:2 },
    { id:"levjambes", n:"Lever de jambes suspendu",    s:3, r:[6,10],  kg:0,  inc:0,   rest:60,  bw:1, tier:2 },
